...
from pipeline.retrieval.graph.bm25_ranker import hybrid_rank
from pipeline.retrieval.graph.dpr_ranker import DPRRanker
from pipeline.retrieval.graph.retrieval_system import extract_verbs, match_relations_graph, match_concepts_graph, \
    k_hop_traversal_mongo, score_triplets_from_traversal, collect_concept_ids_from_relations, \
    link_relations_to_nearby_concepts
from pipeline.retrieval.preprocess_query.query_preprocessor import QueryPreprocessor
...
from pipeline.retrieval.utils.collect_content import collect_sections_content_upward, collect_sections_content_downward
...
class RetrievalPipeline:
    ...
    def merge_and_rank(
        ...
        if self.use_dpr and self.dpr_ranker is not None:
            ...
            from pipeline.retrieval.graph.dpr_ranker import prepare_section_corpus_dpr
