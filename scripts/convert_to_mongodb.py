...
from src.triplet_extraction.doc_extraction.utils import clean_title, strip_markdown_formatting
import pandas as pd
...
def main():
    ...
    data_folder = Path(r"E:\Github\LawAssistant\data\luat_dat_dai")
